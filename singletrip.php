...
<main>
    ...
    <div class="tours_section">
        <h1 class="title-tours">Single Trips</h1>
        <p class="subtitle-tours">Pick up, drop off!</p>
        <div class="tours" id="comments">
            <?php $query="SELECT * FROM tours_and_packages_table WHERE tour_id IN (SELECT tour_id FROM tours_and_packages_single) AND tour_id IN (SELECT tour_id FROM tours_and_packages_singletrip) ORDER BY tour_name LIMIT 8";
