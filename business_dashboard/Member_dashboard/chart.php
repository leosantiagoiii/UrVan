                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive m-b-40">
                                <table class="table table-borderless table-data3">
                                    ...
                                    <tbody>
                                        <?php $query="SELECT * FROM monthly_butaw_table WHERE member_id = '$_SESSION[memberid]'";
                                                    $result=mysqli_query($conn,$query);
                                                    while($rowv=mysqli_fetch_assoc($result)) { ?>
                                        <tr>
                                            <td><?php echo $rowv['id']; ?></td>
                                            <td><?php echo $rowv['member_id']; ?></td>
                                            <td><?php echo $rowv['member_name']; ?></td>
                                            <td><?php echo $rowv['January']; ?></td>
                                            <td><?php echo $rowv['February']; ?></td>
                                            <td><?php echo $rowv['March']; ?></td>
                                            <td><?php echo $rowv['April']; ?></td>
                                            <td><?php echo $rowv['May']; ?></td>
                                            <td><?php echo $rowv['June']; ?></td>
                                            <td><?php echo $rowv['July']; ?></td>
                                            <td><?php echo $rowv['August']; ?></td>
                                            <td><?php echo $rowv['September']; ?></td>
                                            <td><?php echo $rowv['October']; ?></td>
                                            <td><?php echo $rowv['November']; ?></td>
                                            <td><?php echo $rowv['December']; ?></td>
                                            <td><?php echo $rowv['totalpaidup']; ?></td>
                                            <td><?php echo $rowv['balance']; ?></td>
